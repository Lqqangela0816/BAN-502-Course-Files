...
```
```{r}
p1 = ggplot(train, aes(x = Nscore, fill = Nicotine)) + geom_bar(position = "fill")
p2 = ggplot(train, aes(x = Escore, fill = Nicotine)) + geom_bar(position = "fill")
p3 = ggplot(train, aes(x = 	Oscore, fill = Nicotine)) + geom_bar(position = "fill")
...
p4 = ggplot(train, aes(x = Age, fill = Nicotine)) + geom_bar(position = "fill")
grid.arrange(p1,p2,p3,p4)
```
```{r}
